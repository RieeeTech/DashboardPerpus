...
// Status : Done
$done = mysqli_query($db, "SELECT tp.id_pinjam, tm.id_member, tm.nama, tb.judul, tp.tgl_pinjam, tp.tgl_kembali, tp.status FROM tbl_pinjam tp 
JOIN tbl_member tm ON tp.id_member = tm.id_member 
JOIN tbl_buku tb ON tp.id_buku = tb.id_buku WHERE tp.status = 'Done'");
...
<!-- Status : Done -->
    <div class="card mb-6">
      <div class="text-white text-xxl font-weight-bold card-header bg-info">Status : Done</div>
      <div class="card-body">
